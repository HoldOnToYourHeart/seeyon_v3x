...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="98%" align="center" class="categorySet-bg">
	<tr>
		<td class="categorySet-4" height="8">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="categorySet-head" align="center" height="100%">
			<div class="categorySet-body" id="scrollListDiv">
			<%-- 访问控制设置 --%>
			<fieldset style="width: 500px;">
				...
				<table width="400" border="0" cellspacing="0" cellpadding="0" align="center">
					...
					<tr id="tr2">
					<td class="bg-gray" nowrap style="padding-top:12px;"><fmt:message key='sysMgr.lockedUser.ip.label' bundle='${v3xCommonI18N}'/>:</td>
	...
	<tr>
		<td height="42" align="center" class="bg-advance-bottom">
			<input type="submit" value="<fmt:message key='common.button.ok.label' bundle="${v3xCommonI18N}" />" class="button-default-2" ${isDisableStr}>&nbsp;
